...
// you want to add parameter sets, you'll need to convert them to bigintegers.

const biginteger = require('./biginteger');
const sjcl = require("../node_modules/sjcl-full/sjcl");
...
var digest = function(hash){
  return function(data){
    return sjcl.codec.hex.fromBits(sjcl.hash[hash].hash(data));
  };
};

var getk = function(){
  var _k=new biginteger(this.hash(this.N.toString(16)+this.g.toString(16)),16);
